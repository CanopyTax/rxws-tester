...
var ConsoleLogViewer = (function() {
	...
	{
		var alignment = window.location.href.indexOf("console_at_bottom=true") > -1 || window.location.href.indexOf("console_at_top=1") > -1 ? "top-aligned" : "bottom-aligned";
	...
	{
		var css = '#debug_console { background: rgba(0,0,0,.90); font: 12px Arial, sans-serif!important; position:fixed; padding:0; margin:0; z-index:12834567; box-sizing:border-box; pointer-events:none; text-align:left; text-transform:none; }';
